	...
	return (
		<div className="flex min-h-screen flex-col">
			...
			<main className="flex-1">
						...
						<div className="flex flex-col items-center justify-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="max-w-[900px] text-zinc-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
									Un percorso completo per padroneggiare tutti gli elementi
						...
						<div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
							<Card className="p-6 space-y-2">
								...
								<p className="text-zinc-500">
									Respirazione, articolazione, timbro e cadenza per una voce
									chiara e potente
								</p>
							</Card>
							<Card className="p-6 space-y-2">
							...
							<Card className="p-6 space-y-2">
								...
								<p className="text-zinc-500">
									Sviluppo delle capacità di ascolto e connessione emotiva con
									il pubblico
								</p>
							</Card>
						</div>
				...
				<section
					id="program"
					className="w-full py-12 md:py-24 lg:py-32 bg-zinc-50"
				>
					<div className="container px-4 md:px-6">
						<div className="flex flex-col items-center justify-center space-y-4 text-center">
							<div className="space-y-2">
							...
							<div className="flex flex-col justify-center space-y-4">
								<div className="space-y-2">
									...
									<p className="max-w-[600px] text-zinc-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
										Accesso completo al corso online con supporto dedicato e
										materiali esclusivi
									</p>
								</div>
								<div className="flex flex-col gap-2 min-[400px]:flex-row">
			...
			<footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
				<p className="text-xs text-zinc-500">
					© 2024 VoceAlta. Tutti i diritti riservati.
				</p>
