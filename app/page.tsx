    ...
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto px-2 sm:px-4">
          ...
          <div className="mt-12 text-center">
            ...
            <Alert className="mb-8 mx-auto max-w-3xl bg-blue-100 text-blue-800 border-blue-300">
              <AlertTitle className="text-lg font-bold">
                I nuovi corsi inizieranno a settembre 2025.
                <br /> Riserva ora il tuo posto!
              </AlertTitle>
            </Alert>
            <p className="text-lg mb-8 mx-auto max-w-3xl">
              ...
              <br />
              Potrai scegliere tra <b>due classi</b> settimanali, a seconda
              delle tue preferenze, per adattarsi al tuo stile di vita e ai tuoi
              impegni.
              <br />
              In totale, il corso comprende <b>6 lezioni</b> di 90 minuti ogni
              settimana.
              <br />
              Le classi hanno un massimo di <b>6 partecipanti</b> per garantire
              un apprendimento personalizzato e interattivo.
            </p>
            <div className="flex flex-col sm:flex-row gap-2 justify-center">
              <div className="bg-blue-800 text-white p-6 rounded-lg inline-block">
                <div className="flex items-center mb-4">
                  <Calendar className="w-6 h-6 mr-2" />
                  <h3 className="text-xl font-bold">Classe del Martedì</h3>
                </div>
              ...
              <div className="bg-blue-800 text-white p-6 rounded-lg inline-block">
                <div className="flex items-center mb-4">
                  <Calendar className="w-6 h-6 mr-2" />
                  <h3 className="text-xl font-bold">Classe del Mercoledì</h3>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-2 sm:px-4">
          ...
          <h3 className="text-xl md:text-2xl mb-16 text-center text-gray-600">
            Recensioni tratte dalla pagina Facebook
          </h3>
      ...
      <footer className="bg-gradient-to-r from-slate-900 to-indigo-950 text-white py-12">
        <div className="container mx-auto px-2 sm:px-4 text-center">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <Link
              href="https://www.facebook.com/carlo.cartier.seminari.lettura"
              className="bg-white text-indigo-900 p-3 rounded-full hover:bg-indigo-100 transition-colors"
            >
